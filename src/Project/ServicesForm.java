...
private void openPopupDialog() {
        // Create a modal dialog (blocks main frame until closed)
        
        JDialog dialog = new JDialog(this, "Add Service", true);
        ...
        JLabel emailLabel = new JLabel("Service Description:");
        JTextField emailField = new JTextField(15);

        
        JButton submitBtn = new JButton("Add Service");
        //JButton cancelBtn = new JButton("Cancel");
   
       submitBtn.addActionListener(e -> {
        String serviceName = nameField.getText().trim();
        String serviceDescription = emailField.getText().trim();
        ...
        String query = "INSERT INTO tbl_service(service_name, service_description, status, date_uploaded) VALUES (?, ?, ?, CURRENT_DATE)";
        ...
        // Place components using GridBagLayout
        ...
        emailField.setPreferredSize(new Dimension(850, 35));
        ...
        submitBtn.addActionListener(e -> {
            ...
            // 📝 Here’s where you can pass the data to your database
            // For example: Database.insertUser(name, email, contact);
            System.out.println("Saving to DB: " + name + ", " + email);
    ...
    private void initComponents() {
        ...
        jLabel19.setForeground(new java.awt.Color(92, 93, 93));
        jLabel19.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/ICONS/DANG/add.png"))); // NOI18N
        jLabel19.setText("ADD SERVICE");
        jPanel4.add(jLabel19, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 100, 170, 40));
        ...
        jTextField1.setForeground(new java.awt.Color(92, 93, 93));
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Service Name", "Service Description", "Date", "Status", "Action"
            }
        ) {
        ...
        jPanel2.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 210, 250, 60));
    ...
    private void jLabel14MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel14MouseClicked
        new HelperClass(new ReservationForm());
        this.dispose();
    ...
    private void jLabel17MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel17MouseClicked
        new HelperClass(new AdminDashboardForm());
        this.dispose();
